...
const OUTPUT_DIR = path.resolve(
  "C:/Users/10639/chainfm_out/sol/derived/gmgn-wallet-stats-full-1433-live-rerun-001",
);
const REPORT_PATH = path.resolve(
  "harness/reports/SOL-GMGN-WALLET-STATS-FULL-1433-LIVE-RERUN-001/acceptance.md",
);
...
function renderAcceptance(result: WalletProfilePilotResult): string {
  ...
  return `# Acceptance Report: ${FULL_1433_RERUN_TASK_ID}
...
This implementer delivery is not final. The batch may be marked complete only after \`SOL-GMGN-WALLET-STATS-FULL-1433-LIVE-RERUN-001-AUDIT-001\` performs a zero-network independent audit and returns GREEN.
`;
}
