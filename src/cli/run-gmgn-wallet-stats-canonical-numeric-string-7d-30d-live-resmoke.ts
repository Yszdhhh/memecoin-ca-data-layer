...
const TASK_ID = "SOL-GMGN-WALLET-STATS-CANONICAL-NUMERIC-STRING-7D-30D-LIVE-RESMOKE-001";
...
async function main(): Promise<void> {
  const result = await runWalletStatsParserV2Resmoke({
    ...
    outputDir: path.resolve(
      "C:/Users/10639/chainfm_out/sol/derived/gmgn-wallet-stats-canonical-numeric-string-7d-30d-live-resmoke-001",
    ),
  });

  // Output is restricted to sanitized status, budgets, fingerprints, and allowlisted diagnostics.
