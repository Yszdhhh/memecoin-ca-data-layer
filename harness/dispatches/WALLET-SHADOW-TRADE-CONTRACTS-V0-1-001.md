...
- `git diff --check`
- `tsx src/cli/run-wallet-shadow-trade-contracts-v0-1.ts --private-root "$CHAINFM_OUT_DIR" --input-manifest "$CHAINFM_OUT_DIR/shadow/shadow_event_input_manifest.json" --output-private "$CHAINFM_OUT_DIR/shadow/shadow_trade_contracts_v0_1/"`
