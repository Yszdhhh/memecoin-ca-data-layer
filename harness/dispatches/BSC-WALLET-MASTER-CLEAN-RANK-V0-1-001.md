...
- `git diff --check`
- `tsx src/cli/run-bsc-wallet-master-clean-rank-v0-1.ts --private-root "$CHAINFM_OUT_DIR" --input-manifest "$CHAINFM_OUT_DIR/bsc/bsc_source_inventory_manifest.json" --output-private "$CHAINFM_OUT_DIR/bsc/bsc_wallet_master_v0_1/"`
