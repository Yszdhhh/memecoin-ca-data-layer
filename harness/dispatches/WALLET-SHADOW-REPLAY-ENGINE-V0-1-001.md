...
- `git diff --check`
- `tsx src/cli/run-wallet-shadow-replay-engine-v0-1.ts --private-root "$CHAINFM_OUT_DIR" --input-manifest "$CHAINFM_OUT_DIR/shadow/shadow_contracts_input_manifest.json" --output-private "$CHAINFM_OUT_DIR/shadow/shadow_replay_engine_v0_1/"`
