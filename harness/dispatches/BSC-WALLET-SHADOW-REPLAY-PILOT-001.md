...
- `git diff --check`
- `tsx src/cli/run-bsc-wallet-shadow-replay-pilot.ts --private-root "$CHAINFM_OUT_DIR" --input-manifest "$CHAINFM_OUT_DIR/bsc/bsc_shadow_replay_input_manifest.json" --output-private "$CHAINFM_OUT_DIR/bsc/bsc_shadow_replay_pilot_v0_1/"`
