...
| Manual/offline daily and weekly mining runner | DONE, AUDIT PENDING | UTC daily plus Monday weekly job selection is implemented; no cron, timer, background worker, or live trigger is active. |
